...
const TIMELESS_ACTIVITIES: TimelessActivity[] = [
  ...
  },
  {
    ...
    description:
      "Sessions de jet-ski le long de la Cote d'Azur, sensations et panoramas garantis.",
  ...
  {
    id: "bateau-lerins",
    title: "Location de bateau vers les iles Sainte-Marguerite",
    subtitle: "Iles de Lerins, Cannes",
    description:
      "Louer un bateau pour rejoindre les iles de Lerins au large de Cannes : eaux turquoise, criques, Fort Royal. Avec ou sans permis.",
    location: "Cannes",
    icon: Sailboat,
    seasonStart: 4,
    seasonEnd: 10,
