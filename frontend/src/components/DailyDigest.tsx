...
export default function DailyDigest({
  ...
  return (
    <motion.div
      ...
      className="relative overflow-hidden rounded-2xl bg-white/50 p-4 sm:p-6 shadow-elevated backdrop-blur-xl ring-1 ring-white/60"
    >
      ...
      <div className="relative flex flex-wrap items-center gap-x-5 sm:gap-x-8 gap-y-3">
        {/* Total */}
        <div className="flex items-center gap-3">
          ...
          <div>
            <p className="text-xl sm:text-2xl font-bold tabular-nums text-slate-900">{animatedTotal}</p>
        ...
        {featuredCount > 0 && (
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-xl sm:text-2xl font-bold tabular-nums text-slate-900">{animatedFeatured}</p>
              <p className="text-[11px] uppercase tracking-wide text-slate-500">
                a la une
              </p>
            </div>
        ...
        {dealsCount > 0 && (
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-xl sm:text-2xl font-bold tabular-nums text-slate-900">{animatedDeals}</p>
              <p className="text-[11px] uppercase tracking-wide text-slate-500">
                bons plans
              </p>
            </div>
